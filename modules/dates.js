...
class DatesManager {
    ...
    recalculateCurrentDay() {
        ...
        console.log('  baseDate (объект):', baseDateObj.toISOString().split('T')[0]);
        console.log('  currentDate:', currentDateObj.toISOString().split('T')[0]);
